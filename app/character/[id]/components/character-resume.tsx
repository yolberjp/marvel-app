import { HeartOffIcon } from "@/app/components/icons/heart-off";
...
export default function CharacterResume({ character }: CharacterResumeProps) {
    ...
    <div className="relative flex justify-center md:h-69 w-full bg-black">
        <div className="flex flex-col md:flex-row w-full max-w-240">
            <Image src={character.imageUrl} alt={character.name} width={278} height={278} className="w-full aspect-square md:size-69 object-cover object-top" />
            
            <div className="flex flex-col justify-center flex-1 p-12 gap-6">
                <div className="flex justify-between items-center">
                    <h1 className="text-4xl font-bold text-white uppercase">{character.name}</h1>
